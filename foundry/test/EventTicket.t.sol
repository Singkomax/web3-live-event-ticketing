...
contract EventTicketTest is Test {
    ...
    function test_MintTickets() public {
        EventTicket.TicketType[]
            memory ticketTypes = new EventTicket.TicketType[](3);
        ...
        assertEq(
            ...
            "https://mydomain.com/tickets/Regular/1"
        );
        assertEq(
            eventTicket.tokenURI(6),
            "https://mydomain.com/tickets/Special/6"
        );
        assertEq(
            eventTicket.tokenURI(11),
            "https://mydomain.com/tickets/VIP/11"
        );
    }
